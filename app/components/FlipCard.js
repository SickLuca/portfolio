...
// FlipCard - ReactBits component (MIT), from https://reactbits.dev/micro/flip-card
// A 3D card that flips between a front and back face on click / keyboard / drag.
// Only dependency is `motion` (already used elsewhere in this project).
// Local tweak: the component's stylesheet lives in app/globals.css instead of a
// co-located ./FlipCard.css import (Next.js App Router only allows global CSS
// imports from the root layout).
