...
// Living topographic contour map (WebGL shader) from ReactBits (MIT),
// https://reactbits.dev/backgrounds/topography. Kept faithful, with two local
// tweaks: it respects prefers-reduced-motion (renders a single static frame,
// no animation loop) and fails gracefully if WebGL2 is unavailable. The CSS
// the original imported is inlined on the root element.
